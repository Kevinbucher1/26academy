...
import {
  ...
  syntaxTree,
  tags
} from "./chunk-HZ4XPUWN.js";
import {
  CodeInputConfigContext
} from "./chunk-BOFRYBN5.js";
import {
  _extends,
  _objectWithoutPropertiesLoose
} from "./chunk-4RXRYK6B.js";
import {
  rem,
  rgba,
  useRootTheme,
  useTheme
} from "./chunk-O3MPRA36.js";
...
var defaultCodeModes = [
  {
    name: "groq",
    loader: () => import("./dist-ONIQY2IC.js").then(({ javascriptLanguage }) => javascriptLanguage)
  },
  {
    name: "javascript",
    loader: () => import("./dist-ONIQY2IC.js").then(({ javascript }) => javascript({ jsx: false }))
  },
  {
    name: "jsx",
    loader: () => import("./dist-ONIQY2IC.js").then(({ javascript }) => javascript({ jsx: true }))
  },
  {
    name: "typescript",
    loader: () => import("./dist-ONIQY2IC.js").then(
  ...
  { name: "php", loader: () => import("./dist-Q7OZYAXF.js").then(({ php }) => php()) },
  { name: "sql", loader: () => import("./dist-RXCHNVOW.js").then(({ sql }) => sql()) },
  {
    name: "mysql",
    loader: () => import("./dist-RXCHNVOW.js").then(({ sql, MySQL }) => sql({ dialect: MySQL }))
  },
  { name: "json", loader: () => import("./dist-GA6B7ATJ.js").then(({ json }) => json()) },
  {
    name: "markdown",
    loader: () => import("./dist-E6S6RRGL.js").then(({ markdown }) => markdown())
  },
  { name: "java", loader: () => import("./dist-43A2JBSP.js").then(({ java }) => java()) },
  { name: "html", loader: () => import("./dist-OETKULPM.js").then(({ html }) => html()) },
  {
    name: "csharp",
    loader: () => import("./clike-AZV5NGVT.js").then(
      ({ csharp }) => StreamLanguage.define(csharp)
    )
  },
  {
    name: "sh",
    loader: () => import("./shell-YHRNPWOF.js").then(({ shell }) => StreamLanguage.define(shell))
  },
  {
    name: "css",
    loader: () => import("./css-6ZXF4UXQ.js").then(({ css }) => StreamLanguage.define(css))
  },
  {
    name: "scss",
    loader: () => import("./css-6ZXF4UXQ.js").then(({ css }) => StreamLanguage.define(css))
  ...
  {
    name: "sass",
    loader: () => import("./sass-JLR3MO46.js").then(({ sass }) => StreamLanguage.define(sass))
  },
  {
    name: "ruby",
    loader: () => import("./ruby-WI5MPTWI.js").then(({ ruby }) => StreamLanguage.define(ruby))
  },
  {
    name: "python",
    loader: () => import("./python-TTCKBIZU.js").then(
      ({ python }) => StreamLanguage.define(python)
    )
  },
  {
    name: "xml",
    loader: () => import("./xml-JXE6A2OT.js").then(({ xml }) => StreamLanguage.define(xml))
  },
  {
    name: "yaml",
    loader: () => import("./yaml-N4BRLIXP.js").then(({ yaml }) => StreamLanguage.define(yaml))
  },
  {
    name: "golang",
    loader: () => import("./go-ZMJRYSBB.js").then(({ go }) => StreamLanguage.define(go))
  },
  { name: "text", loader: () => {
  } },
  { name: "batch", loader: () => {
...
var CodeMirrorProxy = (0, import_react3.forwardRef)(
  function(props, ref) {
    const _a = props, {
      ...
      "readOnly",
      "value"
    ]), themeCtx = useRootTheme(), codeMirrorTheme = useCodeMirrorTheme(), [editorView, setEditorView] = (0, import_react3.useState)(void 0), themeExtension = useThemeExtension(), fontSizeExtension = useFontSizeExtension({ fontSize: 1 }), languageExtension = useLanguageExtension(languageMode), highlightLineExtension = (0, import_react3.useMemo)(
      () => highlightLine({
        onHighlightChange,
        readOnly,
        theme: themeCtx
    ...
    ), extensions = (0, import_react3.useMemo)(() => {
    ...
    }), []), handleCreateEditor = (0, import_react3.useCallback)((view) => {
      setEditorView(view);
    }, []), basicSetup3 = (0, import_react3.useMemo)(
...
function useLanguageExtension(mode) {
  const codeConfig = (0, import_react3.useContext)(CodeInputConfigContext), [languageExtension, setLanguageExtension] = (0, import_react3.useState)();
...
//# sourceMappingURL=CodeMirrorProxy-VQ3VD5ZJ.js.map
