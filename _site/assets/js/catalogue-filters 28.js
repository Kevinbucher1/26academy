...
(function() {
    ...
    function filterFormations() {
        return allFormations.filter(formation => {
            ...
            if (selectedFilters.financement.length > 0 && 
                !selectedFilters.financement.some(f => formation.financementsFiltres.includes(f))) {
                return false;
            }
    ...
    function getFilterOptions() {
        const options = {
            ...
            financement: [...new Set(allFormations.map(f => f.financementsPossibles).filter(Boolean))],
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        console.log('Sample formation financements:', allFormations[0]?.financementsFiltres);
        console.log('First few formations financements:', allFormations.slice(0, 5).map(f => ({ title: f.titre, financements: f.financementsFiltres })));
